...
export default function Home() {
  ...
  return (
    <main className="bg-black text-white relative overflow-x-hidden min-h-screen">
      ...
      <div className="fixed inset-0 pointer-events-none" style={{ zIndex: 0 }}>
        ...
        {/* 1. Deepest: Animations */}
        <div className="absolute inset-0 opacity-10 z-0"><LiquidBackground /></div>
        <div className="absolute inset-0 opacity-30 z-10"><ParticlesBackground /></div>

        {/* 2. Coding Background (OPACITY FIXED WITH INLINE STYLE + FILTER) */}
        <motion.div 
        ...
        >
          <img 
            ...
            style={{ 
              opacity: 0.3, // <--- Actual Low Opacity
              filter: 'grayscale(100%) brightness(0.8)' // <--- Digital Fade
            }} 
            alt="coding-texture"
          />
        </motion.div>

        {/* 3. Dark Overlay to ensure readability */}
        <div className="absolute inset-0 bg-gradient-to-b from-black via-black/80 to-black z-30" />
      </div>
      ...
      <div className="relative z-50">
            ...
            {section === "about" && (
              ...
              >
                <div className="grid md:grid-cols-4 gap-4">
                  <div className="md:col-span-3 bg-black/60 backdrop-blur-2xl border border-white/10 p-10 rounded-[2.5rem] relative overflow-hidden group shadow-2xl text-left">
                  ...
                  <div className="md:col-span-1 bg-black/60 backdrop-blur-2xl border border-white/15 p-8 rounded-[2.5rem] flex flex-col justify-center items-center text-center group hover:border-purple-500/50 transition-colors">
                  ...
                  <div className="md:col-span-2 bg-black/60 backdrop-blur-2xl border border-white/10 p-10 rounded-[2.5rem] text-left">
        ...
        {/* JOURNEY & STATS */}
        <section id="journey" className="py-32 relative bg-black/80 backdrop-blur-3xl border-y border-white/5">
